 ...
 * <h2>Rendering</h2>
 *
 * <p>In the HTML rendering of this documentation produced by <a href="https://github.com/kvverti/dfu-jd-doclet">
 * this custom doclet</a>, parameterizations of {@link com.mojang.datafixers.kinds.App} and
 * {@link com.mojang.datafixers.kinds.App2} are rendered using the more intuitive form {@code F<T>} mentioned previously.
 * In fact, parameterizations of higher kinded types using {@code App} and {@code App2} are rendered exactly like
 * parameterizations that use the higher kinded type directly. Additionally, all type classes are rendered as
 * {@code TypeClass F}, where {@code F} is the higher kinded type that the type class is defined for. In reality,
