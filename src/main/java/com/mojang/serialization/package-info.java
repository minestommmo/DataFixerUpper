 ...
 * <a href="https://wiki.vg/NBT">NBT</a>. Low-level serialization and deserialization methods in DFU all take a
 * {@link com.mojang.serialization.DynamicOps} object as an argument, through which serialization and deserialization
 * should be delegated. The class {@link com.mojang.serialization.JsonOps} is a provided implementation
