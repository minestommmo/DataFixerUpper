...
public interface Encoder<A> {
    ...
    /**
     * An {@link Encoder} that performs no serialization. Its {@linkplain #encode(Object, DynamicOps, Object) encoding}
     * method always returns the given error.
     *
     * @param error The error the returned encoder should produce.
     * @param <A>   The type the returned encoder operates on.
     * @return An {@link Encoder} that performs no serialization.
     */
